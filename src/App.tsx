      ...
      <div className="flex flex-col min-h-screen bg-background text-on-background relative">
        ...
        <div className="flex-grow">
          <Routes>
            ...
            <Route path="/vuelos/checkout" element={<FlightCheckout />} />
          </Routes>
        </div>
        <Footer />
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.23)] hover:scale-110 transition-all duration-300 flex items-center justify-center animate-bounce-slow"
